...
st.markdown("""<div style="text-align: center;"><img src="https://i.ibb.co/184p60v/logo.png" alt="logo" width="300"></div>""",unsafe_allow_html=True)
...
if selected2 == "About":
    ...
    with about_col1:
        st.markdown("""<div style="text-align: center;"><img src="https://i.ibb.co/6nQf1wp/word-c.png" alt="word-c"></div>""",unsafe_allow_html=True)
...
if selected2 == "Contact":
    c1, c2 = st.columns(2)
    with c1:
        st.markdown("""<div style="text-align: center;"><img src="https://i.ibb.co/gtxQnYX/carousel-3.png" alt="carousel-3"></div>""",unsafe_allow_html=True)
    with c2:
        # st.markdown("<style> .element-container { display: flex; justify-content: center; } </style>", unsafe_allow_html=True)
        c2_1, c2_2 = st.columns(2)
        with c2_1:
            st.markdown("""<div style="text-align: center;">
            <a href="https://www.instagram.com/skinformulator.in/">
            <img src="https://i.ibb.co/g6x5pr3/insta-logo.png" alt="insta-logo" width="250"></a></div>""",unsafe_allow_html=True)

            st.markdown("""<div style="text-align: center;">
            <a href="https://skin-formulator.mini.site">
            <img src="https://i.ibb.co/RDwz9ZL/web-logo.png" alt="web-logo" width="250"></a></div>""",unsafe_allow_html=True)
        
        with c2_2:
            st.markdown("""<div style="text-align: center;">
                <a href="https://wa.me/message/H224ZTDRTT6TC1">
                <img src="https://i.ibb.co/872ZbK4/whatsapp-logo.png" alt="whatsapp-logo" width="250"></a></div>""",unsafe_allow_html=True)
            
            st.markdown("""<div style="text-align: center;">
                <a href="https://skin-formulator.mini.site">
                <img src="https://i.ibb.co/V9m1Kvw/note.png" alt="note" width="250"></a></div>""",unsafe_allow_html=True)
